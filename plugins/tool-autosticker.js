...
if (/video/g.test(mime)) if ((q.msg || q).seconds > 8) return await this.sendButton(m.chat, '*Senden Sie ein max. 7 Sekunden langes Video*', wm, [['AUTOSTICKER DEAKTIVIEREN', '/disable autosticker']], m)
let img = await q.download()
if (!img) return
